...
export default function Flex() {
  const leftImg =
    'https://i0.hdslb.com/bfs/banner/d944eca06e3d6a391ea91a163cfab2669e6124c4.png@976w_550h_1c_!web-home-carousel-cover.avif'
  const rightItem = [
    {
    ...
    },
    {
      ...
      title:
        '连续2个版本冲上T1？冷门大杀器！吸血鬼没你想像得难！猩红收割者弗拉基米尔大型攻略教学【女友会学院-19】',
      up: '寒瞳不是喊痛',
      time: '6-1'
    },
    {
      ...
      title:
        '没有人的讲述是可靠的，隐瞒、欺骗、误解、遗忘、疏忽、错判、误认、异想…',
      up: '神遁局',
      time: '5-15'
    },
    {
    ...
    <div className="container mx-auto p-4">
      <div className="flex gap-2 bg-white">
        <div className="lg:basis-1/2 xl:basis-2/5">
          <img alt="" src={leftImg} className="h-full rounded-lg" />
        </div>
        <div className="lg:basis-1/2 xl:basis-3/5 flex gap-2 flex-wrap max-xl:[&>*:nth-child(5)]:hidden max-xl:[&>*:nth-child(6)]:hidden">
          {rightItem.map((item, index) => (
            <div
              key={index}
              className="lg:basis-[calc(50%-0.5rem)] xl:basis-[calc(33.33%-0.5rem)]"
            >
              <img alt="" src={item.img} className="rounded-lg" />
